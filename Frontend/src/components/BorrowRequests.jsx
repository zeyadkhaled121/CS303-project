              ...
              {filteredData.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Timeline Column */}
                    <td className="px-8 py-5">
                      <div className="flex flex-col gap-1.5 text-[9.5px] min-w-max">
                        <div className="flex items-center gap-2">
                          <span className="font-black text-slate-400 uppercase w-14 text-right">Borrow:</span>
                        ...
                        <div className="flex items-center gap-2">
                          <span className="font-black text-slate-400 uppercase w-14 text-right">Due:</span>
