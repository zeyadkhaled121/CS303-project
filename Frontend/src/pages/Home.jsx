    ...
    switch (selectedComponent) {
      ...
      case "AdminDashboard":
        return isAdmin ? (
          ...
          <UserDashboard searchTerm={searchTerm} />
        );
      ...
      case "Stats":
        return isAdmin ? (
          <Stats setSelectedComponent={setSelectedComponent} />
        ) : (
          <UserDashboard searchTerm={searchTerm} />
        );
      ...
      case "BookManagement":
        return isAdmin ? (
          <BookManagement searchTerm={searchTerm} />
        ) : (
          <UserDashboard searchTerm={searchTerm} />
        );
      ...
      case "BorrowRequests":
        return isAdmin ? (
          <BorrowRequests searchTerm={searchTerm} />
        ) : (
          <UserDashboard searchTerm={searchTerm} />
        );
